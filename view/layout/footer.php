...
<!--                    <p>Stay update with our latest</p>
            ...
            <div class="col-lg-2 col-md-6 col-sm-6">
                <div class="single-footer-widget">
                    <h6>Contact Us</h6>
                    <div class="footer-text">
                        <i class="fa fa-phone"></i>&nbsp;&nbsp;<a href="tel:+919879532383">+919879532383</a> <br>
                        <i class="fas fa-envelope"></i>&nbsp;&nbsp;<a href="mailto:rja@sudevi.in">rja@sudevi.in</a> <br>
        ...
        <div class="row">
            <div class="col-lg-12">
                <center>
                    <p class="footer-text">
                        Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Design & Developed  with <i class="fas fa-heart" aria-hidden="true"></i> by <a href="https://pixelatedegg.com/" target="_blank">Pixelated Egg Digital Ventures - 2020</a> 
                    </p>
                </center>
            </div>
        </div>
